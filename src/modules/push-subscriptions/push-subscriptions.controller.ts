...
export class PushSubscriptionsController {
  ...
  @Post()
  @ApiOperation({ summary: 'Register a web push or Expo push subscription for the current user' })
  async register(@Request() req: any, @Body() dto: RegisterPushSubscriptionDto) {
